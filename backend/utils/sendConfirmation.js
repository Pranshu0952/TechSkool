...
class EmailService {
  ...
  createTransporter() {
    return nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: process.env.CONTACT_EMAIL_USER || 'srivastava546558624696@gmail.com',
        pass: process.env.CONTACT_EMAIL_PASS || 'rwosyadxklvukdqu',
      },
      tls: {
        ...
        <div class="email-container">
            ...
            <div class="email-content">
                ...
                <p class="message-text">
                    ...
                    <small style="color: #94a3b8;">Email: support@studentmanagementsystem.com</small>
                </p>
            </div>
    ...
    try {
      ...
      const mailOptions = {
        from: {
          ...
          address: process.env.CONTACT_EMAIL_USER || 'srivastava546558624696@gmail.com'
        },
        to: email,
  ...
  async sendNotificationEmail(userDetails) {
    ...
    try {
      const mailOptions = {
        ...
        to: process.env.ADMIN_EMAIL || 'krishna2421w@gmail.com',
